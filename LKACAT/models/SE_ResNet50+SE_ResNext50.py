...
class SENet(nn.Module):
    ...
    def __init__(self, block, layers, groups, reduction, dropout_p=0.5,
                 ...
                 downsample_padding=1, num_classes=100, zero_init_residual=False):
...
@register_model
def se_resnet50(num_classes=100, pretrained=None):
...
@register_model
def se_resnext50_32x4d(num_classes=100, pretrained=None):
...
#
#     net = se_resnet50()
#     fe = net(Variable(torch.randn(64, 3, 224, 224)))
#     print(net)
# test1()