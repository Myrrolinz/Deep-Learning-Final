...
#使用Triplet在这里设置：
parser.add_argument("--att-type", type=str, choices=["TripletAttention","VAN","TripletCA","CA","TripletLKA","None"], default="TripletAttention")

#任务类型，用于统一wandb的数据管理
parser.add_argument("--task",type=str,choices=["Triplet_activation","Triplet_sigmoid","Triplet_pool","baseline","flops"])


#设置activation
parser.add_argument("--activation",type=str,choices=['sigmoid','relu','gelu','leaky-relu','celu','elu'],default="sigmoid")
